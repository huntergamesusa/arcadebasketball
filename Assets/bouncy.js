...
if(coll.gameObject.tag == "island" ||coll.gameObject.tag == "cup"){
...
//if(coll.gameObject.tag == "tnt"&& tntHit<1){
//tntHit++;
...
if(colls.gameObject.tag == "5pointfg"||colls.gameObject.tag == "3pointfg"||colls.gameObject.tag == "1pointfg"){
fghit++;
if(fghit<2){
if(colls.gameObject.tag == "5pointfg"){
  GetComponent.<AudioSource>().pitch =1;
         GetComponent.<AudioSource>().PlayOneShot(fgSound,1);
}
else{
