...
static NSString * const kTakePhotoKey = @"Use Camera";
...
static FDTakeController * mySharedInstance;
...
//NEEED TO FIX THIS LINE BELOW
        
      self.imagePicker.sourceType = (UIImagePickerControllerSourceType)[[self.sources objectAtIndex:buttonIndex ] intValue];
//        NSString *strFromInt = [NSString stringWithFormat:@"%d",buttonIndex];
//
//        NSLog(strFromInt);
//        if(buttonIndex == 1){
//        self.imagePicker.sourceType = UIImagePickerControllerSourceTypePhotoLibrary;
//        }
//        else{            self.imagePicker.sourceType = UIImagePickerControllerSourceTypeCamera;
//        }
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    if (CFStringCompare ((CFStringRef) mediaType, kUTTypeImage, 0)
        ...
        UnitySendMessage("ReceiveImage", "ReceiveImageString", [encodedImage UTF8String]);
...
extern "C"
{
    void _NateTest(){
        NSLog(@"Hello");
        [[FDTakeController sharedInstance] takePhotoOrChooseFromLibrary];
