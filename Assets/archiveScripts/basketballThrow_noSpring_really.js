...
//		body.isKinematic = true;
	...
	ragdoll[0].transform.position = hit.point;
...
//rayy=Mathf.Clamp(rayy,460,1000);
		...
		ragdoll[0].gameObject.transform.position = ray.GetPoint(distance);
...
//		   springJoint.connectedBody.angularDrag = oldAngularDrag;
		  ...
		  GetComponent.<basketballThrow_noSpring_really>().enabled = false;
