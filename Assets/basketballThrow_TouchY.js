...
//		leftFootRigid.transform.GetChild(k).GetComponent.<Rigidbody>().interpolation = RigidbodyInterpolation.Interpolate;
		...
		function checkBoard(){
		    ...
		    switch (PlayerPrefs.GetInt("Shoe"))
        {
        case 12:
        var myboard = myshoe.transform.GetChild(12);
      

        
              myboard.gameObject.AddComponent.<FixedJoint>();
       myboard.gameObject.AddComponent.<FixedJoint>();

var fixedJnts : FixedJoint[];
	fixedJnts = myboard.gameObject.GetComponents.<FixedJoint>();
		fixedJnts[0].connectedBody = ragdoll[8];

	fixedJnts[1].connectedBody = ragdoll[10];
            break;
        case 13:
       var myboard2 =  myshoe.transform.GetChild(13);
              myboard2.gameObject.AddComponent.<FixedJoint>();
       myboard2.gameObject.AddComponent.<FixedJoint>();

               
var fixedJnts2 : FixedJoint[];
	fixedJnts2 = myboard2.gameObject.GetComponents.<FixedJoint>();
		fixedJnts2[0].connectedBody = ragdoll[8];

	fixedJnts2[1].connectedBody = ragdoll[10];


            break;
        case 14:
       var myboard3 =  myshoe.transform.GetChild(14);
       
       
       myboard3.gameObject.AddComponent.<FixedJoint>();
       myboard3.gameObject.AddComponent.<FixedJoint>();

var fixedJnts3 : FixedJoint[];
	fixedJnts3 = myboard3.gameObject.GetComponents.<FixedJoint>();
	fixedJnts3[0].connectedBody = ragdoll[8];

	fixedJnts3[1].connectedBody = ragdoll[10];
...
myshoe = newragdollPrefab.transform.Find("Root_jnt/Hips_jnt/UpperLeg_Left_jnt/LowerLeg_Left_jnt/Foot_Left_jnt/Shoes_Left").gameObject;
