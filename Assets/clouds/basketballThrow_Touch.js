...
if(Time.timeScale==1){
	...
	var hit : RaycastHit;
	if (!Physics.Raycast(Camera.main.ScreenPointToRay(Input.GetTouch(0).position),  hit, 220,9))
		return;
...
//
	  ...
	  ySense = Mathf.Clamp(Input.GetTouch(0).deltaPosition.y,0,PlayerPrefs.GetFloat("yClamp"));
...
var newypower:float;
		var mousex = Input.GetTouch(0).deltaPosition.x/100;
...
//		print("mouseZ"+mousez);
		  ...
		  GetComponent.<basketballThrow_Touch>().enabled = false;
